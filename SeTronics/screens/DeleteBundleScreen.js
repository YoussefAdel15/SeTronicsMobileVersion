...
const DeleteBundleScreen = () => {
  const navigation = useNavigation();
  const [BundleName, setBundleName] = useState("");

  const handleDeleteProduct = async () => {
    const object = await getBundleByName(BundleName);
    deletebundle(object);
    alert("Bundle Deleted With Bundle Name : " + BundleName);
  };
  return (
...
export default DeleteBundleScreen;
